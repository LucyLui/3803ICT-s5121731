    ...
    var attScale = d3.scaleSequential()
  					.domain([0, 20])
  					.interpolator(d3.interpolateRgb.gamma(2.2)("green", "white")); //change the colour
	...
	function showMap(dataSet) {
		...
		slider.oninput = function() {
			// TODO
			 currentYear = slider.value; //set slider value as current year
			 output.innerHTML = slider.value; 
	...
	function getCercle(coordinate, r) {
		...
		var area = d3.polygonArea(polygon);
			var radius = r ? r : Math.sqrt(80/ Math.PI);//Change area into 80,the circles look good
